...
import type { CreateCustomGPTRequest } from "@deep-research/types";
...
export default function NewCustomGPTPage() {
  ...
  const { createCustomGPT } = useCustomGPTs();
  const [loading, setLoading] = useState(false);

  const [formData, setFormData] = useState<CreateCustomGPTRequest>({
    name: "",
    description: "",
    instructions: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const request: CreateCustomGPTRequest = {
        ...formData,
        settings: {
          ...formData.settings,
          recommendedModel:
      ...
      const newGPT = await createCustomGPT(request);
    ...
    <div className="container mx-auto py-8 max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Build your personalized AI assistant with custom instructions and knowledge
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              {formData.instructions.length} / 10,000 characters
            </p>
          </CardContent>
        </Card>
